...
<h3 align="center">Full-Stack Developer | Laravel • Vue 3 • PostgreSQL</h3>
...
- 🚀 Full-stack developer with experience building **large-scale citizen portals**
- 🧠 Strong focus on **backend architecture**, **database design**, and **API performance**
- 🛠 Experienced with **admin panels**, **role & permission systems**, and **real-time features**
- 🔄 Comfortable working across **frontend, backend, and database layers**
- 📈 Interested in **scalable systems** and **clean, maintainable code**
...
![Pinia](https://img.shields.io/badge/Pinia-F7D336?style=for-the-badge)
...
- ✔ PostgreSQL functions & performance-optimized queries
- ✔ Role & permission systems
- ✔ Admin dashboards and citizen portals
- ✔ Vue 3 + Vuetify enterprise UI
...
> *“Clean code, scalable architecture, and systems that last.”*
